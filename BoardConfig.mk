...
TARGET_PREBUILT_DTB := $(DEVICE_PATH)/prebuilt/dtbCM-12.0.6
#BOARD_KERNEL_SEPARATED_DTBO := true
BOARD_PREBUILT_DTBOIMAGE := $(DEVICE_PATH)/prebuilt/dtbo.img-12.0.6
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/kernel-12.0.6
